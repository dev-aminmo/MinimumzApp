class StorePostCartsCartReq {
  ...
  /// if you add a publishable data key in the header of this request and specify a sales channel id,
  /// the specified sales channel must be within the scope of the publishable data key's resources.
